...
import (
	...
	ch "github.com/hydnoracoin/node/swarm/chunk"
	"github.com/hydnoracoin/node/swarm/shed"
...
//
// # go test -benchmem -run=none github.com/hydnoracoin/node/swarm/storage/localstore -bench BenchmarkNew -v -timeout 20m
// goos: darwin
// goarch: amd64
