...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/hydnoracoin/node

    go install github.com/hydnoracoin/node/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/hydnoracoin/node`.
...
```
git clone git@github.com:nirname/go-ethereum.git $GOPATH/src/github.com/hydnoracoin/node
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/hydnoracoin/node/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/hydnoracoin/node/wiki/Code-Review-Guidelines).
