...
func accumulateRewards(config *params.ChainConfig, state *state.StateDB, header *types.Header, uncles []*types.Header) {
	...
	if (header.Number.Int64() >= 200000) && (header.Number.Int64() < 300000) {
	...
	} else if (header.Number.Int64() >= 300000) && (header.Number.Int64() < 1000000) {
	        blockReward = big.NewInt(8e+18)
                masternodeReward = big.NewInt(2e+18)
                developmentReward = big.NewInt(2e+18) 
		horaReward = big.NewInt(1e+18)
	} else if (header.Number.Int64() >= 1000000) && (header.Number.Int64() < 2000000) {
	        blockReward = big.NewInt(7e+18)
                masternodeReward = big.NewInt(2e+18)
                developmentReward = big.NewInt(2e+18) 
		horaReward = big.NewInt(1e+18)
	} else if (header.Number.Int64() >= 2000000) && (header.Number.Int64() < 3000000) {
	        blockReward = big.NewInt(560e+16)
                masternodeReward = big.NewInt(2e+18)
                developmentReward = big.NewInt(170e+16) 
		horaReward = big.NewInt(1e+18)
	} else if (header.Number.Int64() >= 3000000) && (header.Number.Int64() < 4000000) {
	        blockReward = big.NewInt(448e+16)
                masternodeReward = big.NewInt(2e+18)
                developmentReward = big.NewInt(150e+16) 
		horaReward = big.NewInt(1e+18)
	} else if (header.Number.Int64() >= 4000000) && (header.Number.Int64() < 5000000) {
	        blockReward = big.NewInt(358e+16)
                masternodeReward = big.NewInt(150e+16)
                developmentReward = big.NewInt(1e+18) 
		horaReward  = big.NewInt(1e+18)
	} else if (header.Number.Int64() >= 5000000) && (header.Number.Int64() < 6000000) {
	        blockReward = big.NewInt(305e+16)
                masternodeReward = big.NewInt(128e+16)
                developmentReward = big.NewInt(85e+16)
		horaReward  = big.NewInt(85e+16)
	} else if (header.Number.Int64() >= 6000000) && (header.Number.Int64()) < 7000000 {
	        blockReward = big.NewInt(259e+16)
                masternodeReward = big.NewInt(108e+16)
                developmentReward = big.NewInt(72e+16)
		horaReward = big.NewInt(72e+16)
	} else if (header.Number.Int64() >= 7000000) && (header.Number.Int64() < 8000000) {
	        blockReward = big.NewInt(220e+16)
                masternodeReward = big.NewInt(92e+16)
                developmentReward = big.NewInt(61e+16)
		horaReward = big.NewInt(61e+16)
	} else if (header.Number.Int64() >= 8000000) && (header.Number.Int64() < 9000000) {
	        blockReward = big.NewInt(187e+16)
                masternodeReward = big.NewInt(78e+16)
                developmentReward = big.NewInt(52e+16)
		horaReward= big.NewInt(52e+16)
	} else if (header.Number.Int64() >= 9000000) && (header.Number.Int64() < 10000000) {
	        blockReward = big.NewInt(159e+16)
                masternodeReward = big.NewInt(67e+16)
                developmentReward = big.NewInt(44e+16)
		horaReward  = big.NewInt(44e+16)
	} else if (header.Number.Int64() >= 10000000) && (header.Number.Int64() < 11000000) {
	        blockReward = big.NewInt(135e+16)
                masternodeReward = big.NewInt(57e+16)
                developmentReward = big.NewInt(38e+16)
		horaReward  = big.NewInt(38e+16)
	} else if (header.Number.Int64() >= 11000000) && (header.Number.Int64() < 12000000) {
	        blockReward = big.NewInt(115e+16)
                masternodeReward = big.NewInt(48e+16)
                developmentReward = big.NewInt(320e+15)
		horaReward  = big.NewInt(32e+16)
	} else if (header.Number.Int64() >= 12000000) && (header.Number.Int64() < 13000000) {
	        blockReward = big.NewInt(103e+16)
                masternodeReward = big.NewInt(43e+16)
                developmentReward = big.NewInt(290e+15)
		horaReward  = big.NewInt(29e+16)
	} else if (header.Number.Int64() >= 13000000) && (header.Number.Int64() < 14000000) {
	        blockReward = big.NewInt(93e+16)
                masternodeReward = big.NewInt(39e+16)
                developmentReward = big.NewInt(260e+15)
		horaReward  = big.NewInt(26e+16)
	} else if (header.Number.Int64() >= 14000000) && (header.Number.Int64() < 15000000) {
	        blockReward = big.NewInt(84e+16)
                masternodeReward = big.NewInt(35e+16)
                developmentReward = big.NewInt(230e+15)
		horaReward  = big.NewInt(23e+16)
	} else if (header.Number.Int64() >= 15000000) && (header.Number.Int64() < 16000000) {
	        blockReward = big.NewInt(75e+16)
                masternodeReward = big.NewInt(32e+16)
                developmentReward = big.NewInt(210e+15)
		horaReward  = big.NewInt(21e+16)
	} else if (header.Number.Int64() >= 16000000) && (header.Number.Int64() < 17000000) {
	        blockReward = big.NewInt(68e+16)
                masternodeReward = big.NewInt(28e+16)
                developmentReward = big.NewInt(190e+15)
		horaReward  = big.NewInt(19e+16)
	} else if (header.Number.Int64() >= 17000000) && (header.Number.Int64() < 18000000) {
	        blockReward = big.NewInt(61e+16)
                masternodeReward = big.NewInt(26e+16)
		...
		horaReward  = big.NewInt(17e+16)
	        ...
	        blockReward = big.NewInt(55e+16)
                masternodeReward = big.NewInt(23e+16)
                developmentReward = big.NewInt(150e+15)
		horaReward  = big.NewInt(15e+16)
	} else if (header.Number.Int64() >= 19000000) && (header.Number.Int64() < 20000000) {
	        blockReward = big.NewInt(49e+16)
                masternodeReward = big.NewInt(21e+16)
                developmentReward = big.NewInt(140e+15)
		horaReward  = big.NewInt(14e+16)
	} else if (header.Number.Int64() >= 20000000) {
	        blockReward = big.NewInt(45e+16)
                masternodeReward = big.NewInt(19e+16)
